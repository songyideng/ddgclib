            ...
            writer.writerow(
                {
                    ...
                    "top_sphere_Fp_n": float(row.get("top_sphere_Fp_n", 0.0)),
                    "top_sphere_Fs_n": float(row.get("top_sphere_Fs_n", 0.0)),
                    "top_sphere_Fv_n": float(row.get("top_sphere_Fv_n", 0.0)),
                    "top_sphere_Fcl_n": float(row.get("top_sphere_Fcl_n", 0.0)),
                    "top_sphere_Ftot_n": float(row.get("top_sphere_Ftot_n", top_sphere_force_n)),
                    "top_sphere_force_n": top_sphere_force_n,
