"""Case 2: dynamic bridge formation with the coupled DEM-fluid solver."""
...
def main() -> None:
    run_case(bridge_formation_config(), out_dir=OUT_DIR, save_fig=True, save_results=True, verbose=True)
